  ...
  return (
    <div>
      <Card className="border-border/50 shadow-xl bg-card/80 backdrop-blur-sm px-4 gap-0">
        ...
        <Card.Footer className="*flex flex-col w-full p-0">
          <div className="relative my-6">
            <div className="absolute inset-0 flex items-center">
              <div className="w-full border-t border-border" />
            </div>
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-card px-2 text-muted-foreground">{t('general.orContinueWith')}</span>
            </div>
          </div>

          <div className="grid grid-cols-2 gap-3 w-full">
            <Button variant="outline" className="h-11" onClick={() => handleOAuthSignIn('google')}>
            ...
            <Button variant="outline" className="h-11" onClick={() => handleOAuthSignIn('github')}>
